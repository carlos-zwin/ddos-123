...
def banner():
  ...
  \\                \  o --/ \ ____________________________/ 
   ...
   \ \__/ '           `  _/ --/                                
    ...
    print(colored("This is a basic ddos tool ", 'yellow'))
    print(colored("Authors: No One ", 'yellow'))
...
def get_proxies():
    URL = "https://raw.githubusercontent.com/carlos-zwin/proxys-socks5/main/proxys.txt"
